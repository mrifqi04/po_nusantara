! function(t, e) {
    ...
    function G(t) {
        le.isVisible() && et !== t.target.value && le.resetValidationMessage(), et = t.target.value
    }
        ...
        e.html ? (tt(e.html, n), O(n, "block")) : e.text ? (n.textContent = e.text, O(n, "block")) : T(n),
            function(t, o) {
                ...
                vt.forEach(function(t) {
                    var e = k[t],
                        n = it(i, e);
                    yt(t, o.inputAttributes), wt(n, e, o), r && T(n)
                }), o.input && r && bt(o)
    ...
    function xt(t, e) {
        ...
        b(n, e.customClass, "header"), Bt(0, e),
            ...
            function(t, e) {
                ...
                O(n), n.setAttribute("src", e.imageUrl), n.setAttribute("alt", e.imageAlt), L(n, "width", e.imageWidth), L(n, "height", e.imageHeight), n.className = k.image, b(n, e.customClass, "image"), e.imageClass && nt(n, e.imageClass)
            }(0, e),
            function(t, e) {
                var n = D();
    ...
    var Tt = [],
        ...
        Rt = Object.freeze({
            ...
            queue: function(t) {
                ...
                function a(t, e) {
                    Tt = [], document.body.removeAttribute("data-swal2-queue-step"), t(e)
                }
                var s = [];
                return new Promise(function(i) {
                    ! function e(n, o) {
                        n < Tt.length ? (document.body.setAttribute("data-swal2-queue-step", n), r.fire(Tt[n]).then(function(t) {
    ...
    function ie(t) {
        var e = q(),
            n = rt();
        null !== t.onBeforeOpen && "function" == typeof t.onBeforeOpen && t.onBeforeOpen(n), t.animation && (nt(n, k.show), nt(e, k.fade)), O(n), dt && j(n) ? (e.style.overflowY = "hidden", n.addEventListener(dt, oe.bind(null, n, e))) : e.style.overflowY = "auto", nt([document.documentElement, document.body, e], k.shown), t.heightAuto && t.backdrop && !t.toast && nt([document.documentElement, document.body], k["height-auto"]), at() && (t.scrollbarPadding && Dt(), function() {
    ...
    var se, ue = Object.freeze({
        ...
        _main: function(t) {
            var c = this;
            ! function(t) {
                for (var e in t) Lt(i = e) || y('Unknown parameter "'.concat(i, '"')), t.toast && (o = e, -1 !== It.indexOf(o) && y('The parameter "'.concat(o, '" is incompatible with toasts'))), Ot(n = void 0) && h(n, Ot(n));
                var n, o, i
            }(t);
            var l = a({}, jt, t);
            ! function(e) {
            ...
            return new Promise(function(t) {
                ...
                Mt.keydownTarget && Mt.keydownHandlerAdded && (Mt.keydownTarget.removeEventListener("keydown", Mt.keydownHandler, {
                    ...
                    T(o), n.inputValue.then(function(t) {
                        ...
                        g("Error in inputValue promise: " + t), o.value = "", O(o), o.focus(), e.hideLoading()
                    })
        ...
        update: function(e) {
            var n = {};
            Object.keys(e).forEach(function(t) {
                le.isUpdatableParameter(t) ? n[t] = e[t] : y('Invalid parameter to update: "'.concat(t, '". Updatable params are listed here: https://github.com/sweetalert2/sweetalert2/blob/master/src/utils/params.js'))
            });
    ...
    }), ce.DismissReason = C, ce.version = "8.13.1";
    var le = ce;
